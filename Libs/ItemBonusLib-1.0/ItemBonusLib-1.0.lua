  ...
  if locale == "enUS" or locale == "enGB" then
    L = {
      NAMES =
      {
        ...
        CASTINGREG = "Regen while casting",

        HEALTHREG = "Life Regeneration",
        VAMPIR = "Vampirism Rating",
      ...
      PATTERNS_PASSIVE =
      {
        ...
        { pattern = "Increases your attack and casting speed by (%d+)%%%.", effect = { "HASTE", "SPELLHASTE" } },
        ...
        { pattern = "(%d+)%%% of damage dealt is returned as healing.", effect = "VAMPIR" },
        { pattern = "Reduces damage taken from critical hits and damage over time effects by (%d+)%%%.", effect = "RESILIENCE" },
